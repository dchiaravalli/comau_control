...
namespace comau_control
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(comau_poseConfig &config, const comau_poseConfig &max, const comau_poseConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const comau_poseConfig &config1, const comau_poseConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, comau_poseConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const comau_poseConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, comau_poseConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const comau_poseConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const comau_poseConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, comau_poseConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
